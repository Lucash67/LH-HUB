...
function StatusStrip({ index, delay }: { index: string; delay: number }) {
  return (
    <motion.div
      ...
      whileHover={{ x: 4 }}
      className="hub-glass-card flex items-center gap-3 rounded-xl border border-[#FFD400]/12 px-3.5 py-3"
    >
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#FFD400]/10 ring-1 ring-[#FFD400]/15">
      ...
      <div className="flex shrink-0 flex-col items-end gap-1">
        ...
        <span className="inline-flex items-center gap-1 text-[9px] text-[#737373]">
          <Zap className="h-2.5 w-2.5 text-[#FFD400]/80" />
          Tempo real
        </span>
      </div>
    </motion.div>
    ...
    <div className="relative flex h-full min-h-[50vh] flex-col lg:min-h-0">
      <div className="relative z-10 flex min-h-0 flex-1 flex-col justify-between px-6 py-8 sm:px-10 lg:px-14 lg:py-10">
        ...
        <div className="mt-10 space-y-4 lg:mt-8">
          ...
          >
            <Radio className="h-3 w-3 text-[#FFD400]" />
            <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#FFD400]/85">
          ...
          >
            <Shield className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#FFD400]/60" />
