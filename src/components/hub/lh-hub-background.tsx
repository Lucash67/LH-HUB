...
/**
 * Camada visual de fundo do OMNI Business.
...
export function LhHubBackground() {
  return (
    <div className="lh-hub-background" aria-hidden>
      ...
      >
        <g stroke="#7C3CFF" fill="none" strokeLinecap="square">
      ...
      <div className="lh-hub-background__particles">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g className="lh-hub-background__wave-guide" stroke="#7C3CFF" fill="none">
            {WAVE_GUIDES.map((d, i) => (
