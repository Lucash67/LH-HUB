...
const PERIOD_META = {
  morning: {
    label: "Manhã",
    icon: Sun,
    gradient: "from-[#FFD400]/20 via-[#FF9500]/10 to-transparent",
    border: "border-[#FFD400]/25",
    accent: "text-[#FFD400]",
    dot: "bg-[#FFD400]",
  },
  lunch: {
...
const STATUS_STYLES = {
  ...
  warning: {
    badge: "bg-[#FFD400]/15 text-[#FFEA70] ring-[#FFD400]/30",
    amount: "text-[#FFEA70]",
  },
  neutral: {
    ...
    <div className="space-y-5 sm:space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 text-xs text-text-muted">
        ...
        <span className="flex flex-wrap items-center gap-x-3 gap-y-1">
          ...
          <span className="flex items-center gap-1">
            <span className="h-2 w-2 rounded-full bg-[#FFD400]" /> Pendente / Perda
          </span>
        </span>
      </div>
